...
import { View, ScrollView, StyleSheet, StyleProp, ViewStyle, Text, TouchableOpacity } from "react-native";
...
const PickerEntry = (props: PickerEntryProps) => {
    ...
    return (
        <TouchableOpacity disabled={props.data.value === undefined} onPress={() => props.onPress(props.data.id)}>
            <View style={getPickerWrapperStyle()}>
                ...
                <CheckBox
                    ...
                    onChange={() => props.onValueChange(props.data.id, props.data.value === undefined)} />
            </View>
        </TouchableOpacity>
    );
}
...
export const Picker = (props: PickerProps) => {
    return (
        <View style={[styles.wrapper, props.style]}>
            <ScrollView>
                {props.data.map((entry) => <PickerEntry key={entry.id} onPress={props.onPress} data={entry} onValueChange={props.onValueChange} />)}
            </ScrollView>
        </View>
    );
}
