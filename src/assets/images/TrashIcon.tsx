...
export const TrashIcon = (props: SVGProps) => {
    return (
        <Svg width={props.width || "100%"} height={props.height || "100%"} viewBox="0 0 43.61 43.6">
            ...
            <Rect x="11" y="19.5" width="3" height="16" rx="1.5" ry="1.5" fill={props.fill || "#FFFFFF"}/>
            <Rect x="17.5" y="19.5" width="3" height="16" rx="1.5" ry="1.5" fill={props.fill || "#FFFFFF"}/>
            <Rect x="24" y="19.5" width="3" height="16" rx="1.5" ry="1.5" fill={props.fill || "#FFFFFF"}/>
        </Svg >
    );
}