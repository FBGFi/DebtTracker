...
export const getDebtHoldersStateFromStorage = async (): Promise<
  TDebtHoldersState | undefined
> => {
...
export function debtHoldersReducer(
  state: TDebtHoldersState,
  action: TAction,
): TDebtHoldersState {
  switch (action.type) {
    ...
    case "switchDebtPaidState":
      state[action.value.debtHolderId].debts[action.value.debtId] =
        !state[action.value.debtHolderId].debts[action.value.debtId];
      break;
...
export const DebtHoldersContext = createContext<{
  state: TDebtHoldersState;
  dispatch: React.Dispatch<TAction>;
}>({ state: debtHoldersInitialState, dispatch: () => {} });
