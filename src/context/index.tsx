...
export const StateProvider = (props: StateProviderProps) => {
  const [debtsState, debtsDispatch] = useReducer(
    debtsReducer,
    debtsInitialState,
  );
  const [debtHoldersState, debtHoldersDispatch] = useReducer(
    debtHoldersReducer,
    debtHoldersInitialState,
  );
  ...
  return (
    <SettingsContext.Provider
      ...
      <DebtHoldersContext.Provider
        value={{ state: debtHoldersState, dispatch: debtHoldersDispatch }}>
        <DebtsContext.Provider
          value={{ state: debtsState, dispatch: debtsDispatch }}>
          {props.children}
        </DebtsContext.Provider>
      </DebtHoldersContext.Provider>
    </SettingsContext.Provider>
